...
@section('content')
    @php
        ...
        $jadwalBimbingans = Auth::user()->hasRole('mahasiswa')
            ? $jadwalBimbingans->where('mahasiswa_id', Auth::user()->mahasiswa->id)
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('add-riwayat-mahasiswa') }}" method="POST"
                                                                        ...
                                                                        <div class="modal fade"
                                                                            ...
                                                                            <div class="modal-dialog modal-dialog-centered">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body ">
                                                                                        <form
                                                                                            action="{{ route('edit-riwayat-mahasiswa', $riwayat->id) }}"
                                                                                            ...
                                                                                            <div class="row mb-3 mt-2">
                                                                                                ...
                                                                                                @endrole
                                                                                                <div class="col-12 mb-3">
                                                                                                    <label for="catatan_mahasiswa">Catatan Mahasiswwa</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control bg-white text-dark"
                                                                                                        name="catatan_mahasiswa" required
                                                                                                        value="{{ old('catatan_mahasiswa', $riwayat->catatan_mahasiswa) }}">
                                                                                                </div>
