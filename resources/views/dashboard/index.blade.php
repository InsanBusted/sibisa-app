                                    ...
                                    {{-- <form action="{{route('search-jadwal')}}" method="GET"> --}}
                                        <div class="input-group rounded">
                                            <input type="search" class="form-control rounded" name="search" id="search-bar"
                                                placeholder="Cari Mahasiswa,Dosen" aria-label="Search"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header text-white bg-dark">
                                                            <h5 class="modal-title" id="editjadwalLabel{{ $jadwal->id }}">Edit Jadwal</h5>
                                                            <button type="button" class="btn-close text-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body ">
                                                            <form action="{{ route('edit-jadwal', $jadwal->id) }}" method="post">
                                                                @csrf
                                                                @method('put')
                                                                <div class="row mb-3 mt-2">
                                                                    <div class="col-12 mb-3">
                                                                        <input type="date" class="form-control bg-white text-dark" name="tanggal" required value="{{ old('tanggal', $jadwal->tanggal) }}">
                                                                    </div>
                                                                    <div class="col-12 mb-3">
                                                                        <input type="time" class="form-control bg-white text-dark" name="jam" required value="{{ old('jam', $jadwal->jam) }}">
                                                                    </div>
                                                                    <div class="col-12 mb-3">
                                                                        <label for="status">Status</label>
                                                                        <select class="form-control bg-white text-dark" name="status" required>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary text-white" data-bs-dismiss="modal">Kembali</button>
                                            ...
                                            <!-- Delete Modal -->
                                            <div class="modal fade mt-5" id="deletejadwal{{ $jadwal->id }}" tabindex="-1" aria-labelledby="deletejadwalLabel{{ $jadwal->id }}" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="deletejadwalLabel{{ $jadwal->id }}">HAPUS JADWAL</h5>
